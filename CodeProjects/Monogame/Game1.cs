...
namespace Monogame
{
	...
	public class Game1 : Game
	{
		...
		///Example setup - delete as required
				Vector3 eye;
		Vector3 up;
		Vector3 at;
		...
		protected override void Initialize()
		{
			...
			/// Example initialization - delete as required
			zNear = 0.001f;
			zFar = 1000.0f;
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			/// Example Draw call - delete as required

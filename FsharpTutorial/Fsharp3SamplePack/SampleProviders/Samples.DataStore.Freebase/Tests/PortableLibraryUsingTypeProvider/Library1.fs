...
//let bonds = ctxt.``Science and Technology``.Spaceflight.Astronauts.Individuals.

//ctxt.``Science and Technology``.Spaceflight.``Rocket Functions``.Individuals.
//let bonds = ctxt.``Science and Technology``.Chemistry.``Chemical Elements``
//ctxt.``Science and Technology``.Meteorology.Clouds.